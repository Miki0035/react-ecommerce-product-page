...
export const product: ProductInfo = {
    ...
    productImage: [
        {
            img: new URL("../assets/images/image-product-1.jpg", import.meta.url)
                .href,
            thumbnail: new URL(
        ...
        {
            img: new URL("../assets/images/image-product-2.jpg", import.meta.url)
                .href,
            thumbnail: new URL(
        ...
        {
            img: new URL("../assets/images/image-product-3.jpg", import.meta.url)
                .href,
            thumbnail: new URL(
        ...
        {
            img: new URL("../assets/images/image-product-4.jpg", import.meta.url)
                .href,
            thumbnail: new URL(
